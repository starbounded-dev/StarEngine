...
IncludeDir["Box2D"] = "%{wks.location}/StarEngine/vendor/Box2D"
...
LibraryDir["VulkanSDK_Debug"] = "%{wks.location}/StarEngine/vendor/VulkanSDK/Lib"
LibraryDir["VulkanSDK_DebugDLL"] = "%{wks.location}/StarEngine/vendor/VulkanSDK/Bin"
