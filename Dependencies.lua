...
IncludeDir["FMODCore"] = "%{wks.location}/StarEngine/vendor/FMOD-Audio/AudioEngine/Include"
IncludeDir["FMODEngine"] = "%{wks.location}/StarEngine/vendor/FMOD-Audio/AudioEngine"
