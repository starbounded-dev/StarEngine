...
#define HZ_PROFILE_SCOPE(name) constexpr auto fixedName = ::StarStudio::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
									::StarStudio::InstrumentationTimer timer##__LINE__(fixedName.Data)
