...
4. After donwloading and unzipping the files, the [Win-GenProjects.bat](https://github.com/starbounded-dev/StarEngine/blob/master/scripts/Win-GenProjects.bat) script file will get executed automatically, which will then generate a Visual Studio solution file for user's usage.
