...
namespace StarEngine {
	...
	static StarEngine::AllocationStats s_GlobalStats;
...
{
	return StarEngine::Allocator::Allocate(size);
}
...
{
	return StarEngine::Allocator::Allocate(size, desc);
}
...
{
	return StarEngine::Allocator::Allocate(size, file, line);
}
