...
namespace StarEngine {
		...
		: m_Data(new MSDFData())
	{
		...
		if (!font)
		{
			SE_CORE_ERROR("Failed to load font: {}", fileString);
			return;
		}
		...
		SE_CORE_INFO("Loaded {} glyphs from font (out of {})", glyphsLoaded, charset.size());
...
#define THREAD_COUNT 8
	...
	RefPtr<Font> Font::GetDefault()
	{
		...
		if (!DefaultFont)
			DefaultFont = RefPtr<Font>::Create("assets/fonts/opensans/OpenSans-Regular.ttf");
